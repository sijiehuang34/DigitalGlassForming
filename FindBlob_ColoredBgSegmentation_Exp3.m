%% FindBlob_ColoredBgSegmentation_Exp3.m
...
expCase = '10L_0.5mms_40W_20mm_4mmAboveFocus_FlatTip\';
expImg = 'images\Acquisition560.jpeg';
saveDir = 'E:\SFF\Exp3_JoiningTracks\10L_0.5mms_40W_20mm_4mmAboveFocus_FlatTip\';
fullImagePath = [expName, expCase, expImg];
image = imread(fullImagePath);

% Define substrate region
substrate_start_row = 1250;
w_hypodermic = 2e-3; % m
w_filament = 1.5e-3; % m
...
% Region 1 (lower part)
region1_a = a_channel(1000:region_height, 1:region_width);
region1_b = b_channel(1000:region_height, 1:region_width);
...
epsilon = 0.15;      % Distance threshold in mm (tune as needed)
