%% FindBlob_ColoredBgSegmentation_Exp3_16L.m
...
expCase = '16L_0.5mmsPRINT_40W_20mm_4mmAboveFocus_FlatTip_0mmOverlap_1mmsRETRACT\';
expImg = 'images\Acquisition610.jpeg';
saveDir = 'E:\SFF\Exp3_JoiningTracks\16L_0.5mmsPRINT_40W_20mm_4mmAboveFocus_FlatTip_0mmOverlap_1mmsRETRACT\';
fullImagePath = [expName, expCase, expImg];
image = imread(fullImagePath);

% Define substrate region
substrate_start_row = 1245;
w_hypodermic = 2e-3; % m
w_filament = 1.5e-3; % m
...
% Region 1 (lower part)
region1_a = a_channel(1100:region_height, 1:region_width);
region1_b = b_channel(1100:region_height, 1:region_width);
...
epsilon = 0.20;      % Distance threshold in mm (tune as needed)
